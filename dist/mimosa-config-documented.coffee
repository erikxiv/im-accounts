...
exports.config = {
  ...
  ###
  modules: ["server","minify-js","minify-css","jshint","csslint","live-reload","require","copy","bower","combine","lint","minify","requirebuild-include","requirebuild-textplugin-include","web-package"]
